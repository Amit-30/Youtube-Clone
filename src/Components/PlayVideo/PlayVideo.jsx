...
const PlayVideo = () => {
  ...
  const fetchOtherData = () => {
    ...
    const channelData_url = `https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics&id=${
      apiData ? apiData.snippet.channelId : "UC_x5XG1OV2P6uZZ5FSM9Ttw"
    }&key=${data.apiKey}`;
    ...
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          <span>
            <img src={like} alt="" />
            {apiData ? value_converter(apiData.statistics.likeCount) : "4.7K"}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="video-description">
        ...
        <hr />
        <h4>
          {apiData ? value_converter(apiData.statistics.commentCount) : "149"}{" "}
          comments
        </h4>
